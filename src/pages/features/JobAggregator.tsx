    ...
    <div className="bg-[#F5F7FA] min-h-screen">
      ...
      <div className="pt-[100px]">
        <section className="max-w-[780px] mx-auto px-6 text-center pb-6">
          ...
          <p className="text-[#666] text-[14px] md:text-[15px] max-w-[660px] mx-auto mb-7 leading-relaxed">FirstResume simplifies your job search by aggregating job postings from 20 top job boards into one powerful platform. No more switching between multiple websites.</p>
          <PillButton>Get Started &nbsp;→</PillButton>
        </section>
        <section className="bg-[#eef0f4] py-5 border-y border-[#dde1e8]"><p className="text-center text-[14px] md:text-[15px] text-[#1a1a1a] font-medium max-w-[700px] mx-auto px-6">For every job search (loop) that you create, FirstResume will search in 20 Job boards, will aggregate the job results in a single dashboard.</p></section>
        ...
        <section className="max-w-[1000px] mx-auto px-6 py-14">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1 space-y-4 max-w-[400px]"><h3 className="text-[22px] md:text-[26px] font-extrabold text-[#1a1a1a]">Filter And View Jobs By Job Board</h3><p className="text-[#666] text-[14px] leading-relaxed">In the All Matches tab on your FirstResume dashboard, you can use the filters to see jobs from specific job boards.</p><PillButton>Start today</PillButton></div>
        ...
        <section className="max-w-[1000px] mx-auto px-6 py-14">
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 space-y-4 max-w-[400px]"><h3 className="text-[22px] md:text-[26px] font-extrabold text-[#1a1a1a]">Check The Job Posting Details</h3><p className="text-[#666] text-[14px] leading-relaxed">When you open a job match in FirstResume, you'll see the job board's name directly in the job details with full transparency.</p><PillButton>Start today</PillButton></div>
          </div>
        </section>
