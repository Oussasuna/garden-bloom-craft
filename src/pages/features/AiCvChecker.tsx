    ...
    <div className="bg-white min-h-screen">
      <section className="relative overflow-hidden bg-white pt-[140px] pb-0">
        <div className="max-w-[1140px] mx-auto px-4 text-center">
          ...
          <a href="https://app.firstresume.ai" className="inline-flex items-center bg-black text-white px-6 py-3 rounded-[4px] font-semibold text-[15px] hover:opacity-85 transition-opacity mb-16">Check your CV score with AI →</a>
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-7/12 mb-12 lg:mb-0 lg:pr-12">
              ...
              <ol className="list-none p-0 m-0 space-y-6 mb-10">
                {[{ num: "01", text: "Upload your CV in our automated AI checker" }, { num: "02", text: "FirstResume will scan your CV and identify if it follows best practices and if it is ATS friendly" }, { num: "03", text: "FirstResume will use AI to provide targeted recommendations to make it ATS friendly and get you interviews" }, { num: "04", text: "Set your optimized CV as default and start automating your job applications with AI" }].map((item) => (
              ...
              <a href="https://app.firstresume.ai" className="inline-flex items-center px-6 py-3 border border-[#6c757d] rounded-[4px] text-[16px] font-semibold text-[#6c757d] bg-transparent hover:bg-black/5 transition-colors">Start today</a>
            </div>
      ...
      <section className="bg-black py-[80px] md:py-[100px] text-center px-6">
        ...
        <p className="text-white/90 text-[18px] max-w-[800px] mx-auto mb-8 leading-[1.6]">FirstResume users get in average 50% more interviews and they spend 10 hours less per week. Start automating your job search today.</p>
        <a href="https://app.firstresume.ai" className="inline-flex items-center bg-[#cbd5e0] text-black px-8 py-3 rounded-[4px] font-semibold text-[18px] hover:bg-white transition-colors mb-4">Start Free Trial</a>
