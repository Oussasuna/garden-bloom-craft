    ...
    <div className="bg-[#F5F7FA] min-h-screen">
      ...
      <div className="pt-[100px]">
        <section className="max-w-[900px] mx-auto px-6 text-center pb-8">
          ...
          <p className="text-[#555] text-[16px] md:text-[18px] max-w-[680px] mx-auto mb-8 leading-relaxed">Install our chrome extension from the web store, select the jobs you want to apply for, and FirstResume do the rest.</p>
        ...
        <section className="relative mt-6 mb-0">
          ...
          <div className="relative max-w-[700px] mx-auto px-6 pb-6">
            <div className="bg-[#f0f2f5] rounded-2xl py-16 px-8 max-w-[600px] mx-auto flex items-center justify-center gap-0">
              <div className="w-[80px] h-[80px] rounded-full bg-[#1a1a1a] flex items-center justify-center flex-shrink-0"><span className="text-white text-[24px] font-extrabold">FR</span></div>
        ...
        <section className="max-w-[900px] mx-auto px-6 text-center pb-14"><h2 className="text-[28px] md:text-[36px] font-extrabold text-[#1a1a1a]">Getting Started With The FirstResume Extension</h2></section>
