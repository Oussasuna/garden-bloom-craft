...
const StarIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
    <path d="M9 0L11.0206 6.9794L18 9L11.0206 11.0206L9 18L6.9794 11.0206L0 9L6.9794 6.9794L9 0Z" fill="#0f0f0f" />
  </svg>
);
...
export default function AiCoverLetterPage() {
  ...
  return (
    <>
      <section className="relative bg-white pt-[80px] pb-[60px]">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center">
          <span className="text-[13px] font-semibold text-[#3b82f6] mb-4 uppercase tracking-[0.05em]">#1 AI Cover Letter Generator for GenZ</span>
          <h1 className="text-[32px] md:text-[48px] font-extrabold text-[#0f0f0f] leading-[1.1] tracking-[-0.02em] max-w-[900px] mb-6">
            Create personalized cover letter to connect with hiring managers in seconds.
          </h1>
          <p className="text-[18px] text-[#52525b] leading-[1.6] max-w-[720px] mb-8">
          ...
          <a href="https://app.jobexcv.ai" className="inline-flex items-center justify-center bg-[#0f0f0f] text-white px-7 py-[14px] rounded-full text-[16px] font-semibold transition-all duration-200 hover:scale-[1.02] mb-12">
            Create your cover letter now
          </a>
          <div className="w-full max-w-[1040px] rounded-[16px] overflow-hidden border border-[#e4e4e7] shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
        ...
        <div className="mt-16 max-w-[1200px] mx-auto px-6">
          <p className="text-[13px] font-semibold text-[#71717a] uppercase tracking-[0.05em] mb-8 text-center opacity-60">Trusted around the world</p>
      ...
      <section className="bg-[#f9fafb] py-[100px]">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center">
          <span className="text-[13px] font-semibold text-[#3b82f6] mb-4 uppercase tracking-[0.05em]">How it works?</span>
          <h2 className="text-[36px] md:text-[42px] font-bold text-[#0f0f0f] leading-[1.2] text-center max-w-[800px] mb-[60px]">First prepare a resume ... Click, and BAM! There is your cover letter.</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mb-[48px]">
            {[{ icon: "🔍", title: "Step 1:\nFind a job post", desc: "Start searching for jobs anywhere you want and paste the job description in the box in JobExCV." }, { icon: "📄", title: "Step 2:\nPrepare the resume", desc: "Use JobExCV to prepare a tailored resume for the job in one click." }, { icon: "✉️", title: "Step 3:\nClick ... there you go", desc: "One click, and your cover letter is ready. Feel free to manually edit it if needed." }].map((step, i) => (
              <div key={i} className="flex flex-col items-center text-center bg-[#f9fafb] border border-[#e4e4e7] rounded-[16px] p-6">
                <div className="mb-6 text-3xl">{step.icon}</div>
                <h3 className="text-[20px] font-bold text-[#0f0f0f] mb-4 leading-[1.3] whitespace-pre-line">{step.title}</h3>
                <p className="text-[16px] text-[#71717a] leading-[1.6]">{step.desc}</p>
              </div>
            ))}
          </div>
          <a href="https://app.jobexcv.ai" className="bg-[#0f0f0f] text-white px-7 py-[14px] text-[16px] font-semibold rounded-full transition-all duration-200 hover:scale-[1.02]">That's it! Give it a go!</a>
        </div>
      </section>

      <section className="bg-[#0f0f0f] py-[100px] px-6 text-white text-center">
        <div className="max-w-[1200px] mx-auto">
          <p className="text-[13px] font-semibold text-[#3b82f6] mb-4 uppercase tracking-[0.05em]">What is special about us?</p>
          <h2 className="text-[36px] md:text-[42px] font-bold leading-[1.2] mb-6 max-w-[800px] mx-auto">Our AI ensures alignment between your resume and cover letter.</h2>
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-[600px] rounded-[16px] overflow-hidden border border-white/10 shadow-2xl">
      ...
      {[{ title: "Save Hours On Every Application.", desc: "Transform cover letter writing from 45 minutes to 2 minutes, letting you focus on what matters most in your job search.", img: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/3cede011-02d0-436d-8d5d-66ecb52fb49b-firstresume-ai/assets/images/692e546ee175581f7f5f5b0d_Demo_20graphics_20_Square-14.jpg", cta: "Create your cover letter", bullets: ["One-click generation saves you hours of writing and editing", "No more staring at blank pages wondering what to write", "Focus on job searching while AI handles the writing"], reverse: false }, { title: "Strengthen Your Job Applications.", desc: "Stand out from other candidates with cover letters that showcase your experience and story in the most impactful way possible.", img: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/3cede011-02d0-436d-8d5d-66ecb52fb49b-firstresume-ai/assets/images/692e562f1dada2f69eea882e_Demo_20graphics_20_Square-15.jpg", cta: "Beat your competition", bullets: ["Highlight achievements that best match the job requirements", "Create natural connections with the company's values", "Include relevant keywords that align with the job description"], reverse: true }, { title: "No More Stiff, Generic Cover Letter Templates.", desc: "Say goodbye to stiff, cookie-cutter cover letters. Create natural, conversational writing that actually sounds human.", img: "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/3cede011-02d0-436d-8d5d-66ecb52fb49b-firstresume-ai/assets/images/692e581f848d9b7de0aab630_Demo_20graphics_20_Square-17.jpg", cta: "Personalize today", bullets: ["Fresh, personalized content instead of overused templates", "Natural language that engages hiring managers", "Professional yet conversational tone that stands out"], reverse: false }].map((block, i) => (
        <section key={i} className={`py-[100px] ${i % 2 === 0 ? "bg-white" : "bg-[#f9fafb]"} overflow-hidden`}>
          <div className="max-w-[1200px] mx-auto px-6">
            <div className={`flex flex-col ${block.reverse ? "md:flex-row-reverse" : "md:flex-row"} items-center gap-12 md:gap-[80px]`}>
              <div className="flex-1">
                <h2 className="text-[36px] lg:text-[42px] font-bold text-[#0f0f0f] leading-[1.2] mb-6">{block.title}</h2>
                <p className="text-[#71717a] text-[18px] leading-[1.6] mb-8">{block.desc}</p>
                <ul className="space-y-4 mb-10">
                  {block.bullets.map((text, j) => (
                    <li key={j} className="flex items-start gap-3">
                      <div className="mt-1 flex-shrink-0"><StarIcon /></div>
                      <span className="text-[#0f0f0f] text-[16px] font-medium">{text}</span>
                    </li>
                  ))}
                </ul>
                <a href="https://app.jobexcv.ai" className="inline-flex items-center justify-center bg-[#0f0f0f] text-white px-7 py-[14px] rounded-full text-[16px] font-semibold transition-all duration-200 hover:scale-[1.02]">{block.cta}</a>
              </div>
              <div className="flex-1">
                <img src={block.img} alt={block.title} className="rounded-[16px] border border-[#e4e4e7] w-full h-auto max-w-[500px] mx-auto" />
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="bg-white py-[100px]">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-[13px] font-semibold text-[#3b82f6] mb-4 uppercase tracking-[0.05em]">What our users say</p>
            <h2 className="text-[36px] md:text-[42px] font-bold text-[#0f0f0f] mb-8">Loved by the community.</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
            {[{ num: "562,192", label: "Users" }, { num: "4.9/5", label: "Rating" }, { num: "39", label: "Countries" }, { num: "625,000+", label: "Job applications" }].map((stat, i) => (
              <div key={i} className="bg-[#f9fafb] p-8 rounded-[16px] text-center border border-[#e4e4e7]">
                <div className="text-[32px] font-bold text-[#0f0f0f] mb-1">{stat.num}</div>
                <div className="text-[14px] font-bold text-[#71717a] uppercase">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#f9fafb] py-[100px]">
        <div className="max-w-[900px] mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-[36px] md:text-[42px] font-bold text-[#0f0f0f] leading-[1.2]">Frequently Asked Questions</h2>
          </div>
          <div className="space-y-3">
            {faqItems.map((item, i) => (
              <div key={i} className="overflow-hidden rounded-[16px] border border-[#e4e4e7] bg-white">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="flex w-full items-center justify-between px-6 py-5 text-left hover:bg-[#f9fafb] transition-all duration-200">
                  <span className="text-[16px] font-bold text-[#0f0f0f] pr-4">{item.question}</span>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openFaq === i ? "max-h-[500px]" : "max-h-0"}`}>
                  <div className="border-t border-[#e4e4e7] px-6 py-5 text-[16px] leading-[1.6] text-[#71717a]">{item.answer}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-[#0f0f0f] py-[100px] text-center px-6">
        <h2 className="text-[36px] md:text-[42px] font-bold text-white mb-6 leading-[1.2]">Still Not Convinced? Start With Free Account!</h2>
        <p className="text-white/80 text-[18px] max-w-[800px] mx-auto mb-8 leading-[1.6]">JobExCV users get in average 50% more interviews and they spend 10 hours less per week.</p>
      ...
      <section className="bg-[#f9fafb] py-[100px] text-center px-6">
        <h2 className="text-[36px] md:text-[42px] font-bold text-[#0f0f0f] mb-8 leading-tight">JobExCV Helps You Find A Job Faster</h2>
        <a href="https://app.jobexcv.ai" className="inline-flex items-center justify-center bg-[#0f0f0f] text-white px-7 py-[14px] rounded-full font-semibold text-[16px] transition-all duration-200 hover:scale-[1.02]">Get Started Now</a>
      </section>
    </>
  );
}
