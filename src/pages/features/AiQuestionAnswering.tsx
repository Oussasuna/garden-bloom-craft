    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-black py-[80px] lg:py-[100px]">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center">
          ...
          <p className="text-white text-[16px] md:text-[18px] leading-[1.6] mb-10 max-w-[850px] opacity-90">JobExCV users get in average 50% more interviews and they spend 10 hours less per week.</p>
