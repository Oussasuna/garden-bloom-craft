    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative overflow-hidden bg-white pt-[140px] pb-0">
        <div className="max-w-[1140px] mx-auto px-4 text-center">
          ...
          <a href="https://app.jobexcv.ai" className="inline-flex items-center bg-black text-white px-6 py-3 rounded-[4px] font-semibold text-[15px] hover:opacity-85 transition-opacity mb-16">Let's Get Started your automatic job applications! →</a>
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-7/12 mb-12 lg:mb-0 lg:pr-12">
              ...
              <ol className="list-none p-0 m-0 space-y-8 mb-10">
                {[{num:"01",text:"1) Click the button that automatically fills the input with our AI generated answer"},{num:"02",text:"2) In the background JobExCV will search your previous questions and answers as well as your CV/Resume"},{num:"03",text:"3) With a single click you can answer the question and submit the job application"}].map(item=>(<li key={item.num} className="flex items-start"><span className="text-[14px] font-bold text-[#b8c2cc] border-b border-[#b8c2cc] pb-[2px] mr-5 shrink-0">{item.num}</span><span className="text-[17px] text-[#4a4a4a] leading-[1.6]">{item.text}</span></li>))}
              </ol>
              <a href="https://app.jobexcv.ai" className="inline-flex items-center px-6 py-3 border border-black rounded-[4px] text-[15px] font-semibold text-black bg-transparent hover:bg-black/5 transition-colors">Start today</a>
            </div>
      ...
      <section className="bg-black py-[80px] md:py-[100px] text-center px-6">
        ...
        <a href="https://app.jobexcv.ai" className="inline-flex items-center bg-[#e8ebf0] text-black px-8 py-4 rounded-[4px] font-semibold text-[16px] hover:bg-white transition-colors mb-4">Start Free Trial</a>
