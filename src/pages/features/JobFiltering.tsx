    ...
    <div className="bg-[#F5F7FA] min-h-screen">
      ...
      <div className="pt-[100px]">
        <section className="max-w-[900px] mx-auto px-6 text-center pb-8">
          ...
          <p className="text-[#555] text-[16px] md:text-[18px] max-w-[680px] mx-auto mb-8 leading-relaxed">JobExCV can filter job descriptions based on specific keywords that you can set. Stop getting jobs that LinkedIn thinks is a good fit. Set your own rules.</p>
        ...
        <section className="max-w-[1000px] mx-auto px-6 py-20">
          <div className="flex flex-col md:flex-row gap-12 items-start">
            <div className="flex-1 max-w-[460px]">
              <h2 className="text-[24px] md:text-[32px] font-extrabold text-[#1a1a1a] leading-tight mb-8">With JobExCV You Set Your Own Rules</h2>
