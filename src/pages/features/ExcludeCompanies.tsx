      ...
      <div className="flex min-h-[380px]">
        <div className="w-[160px] bg-[#fafbfc] border-r border-[#e5e7eb] py-4 px-3 flex-shrink-0">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-[11px] font-bold text-[#1a1a1a]">jobexcv</span>
          </div>
        ...
        <div className="flex-1 p-5 overflow-hidden">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-[10px] text-[#64748b] font-medium block mb-1">Do you want to exclude some companies?</label>
              <div className="h-7 rounded border border-[#e0e4ea] bg-[#f9fafb] px-2 flex items-center"><span className="text-[9px] text-[#94a3b8]">Yes</span></div>
            </div>
            <div>
              <label className="text-[10px] text-[#64748b] font-medium block mb-1">Companies to not review</label>
              <div className="min-h-[32px] rounded border border-[#e0e4ea] bg-[#f9fafb] px-2 py-1 flex flex-wrap gap-1">
                {["Acme Corp", "OldEmployer Inc"].map((c) => (
                  <span key={c} className="text-[8px] bg-[#e8edf2] text-[#1a1a1a] px-1.5 py-0.5 rounded font-medium">{c} &times;</span>
                ))}
              </div>
            </div>
            <div>
              <label className="text-[10px] text-[#64748b] font-medium block mb-1">Select the keywords that should be present in the job posting</label>
              <div className="min-h-[32px] rounded border border-[#e0e4ea] bg-[#f9fafb] px-2 py-1 flex flex-wrap gap-1">
            ...
            <div>
              <label className="text-[10px] text-[#64748b] font-medium block mb-1">Keywords</label>
              <div className="h-7 rounded border border-[#e0e4ea] bg-[#f9fafb] px-2 flex items-center"><span className="text-[9px] text-[#94a3b8]">Type keywords...</span></div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3.5 h-3.5 rounded border border-[#e0e4ea] bg-[#14b8a6] flex items-center justify-center"><span className="text-white text-[8px]">&#10003;</span></div>
    ...
    <div className="bg-[#F5F7FA] min-h-screen">
      ...
      <section className="bg-[#1e293b] pt-16 pb-0">
        <div className="max-w-[780px] mx-auto px-6 text-center pb-10">
          ...
          <p className="text-[#b0bec5] text-[14px] md:text-[15px] max-w-[620px] mx-auto mb-7 leading-relaxed">JobExCV is smart enough to not apply by mistake to your previous employees or companies that you don&apos;t want to.</p>
      ...
      <section className="max-w-[1000px] mx-auto px-6 py-20">
        <p className="text-[12px] text-[#94a3b8] font-medium mb-2 tracking-wide">Advanced job search preferences</p>
        <div className="flex flex-col md:flex-row gap-12 items-start">
          <div className="flex-1 max-w-[460px]">
            ...
            <div className="space-y-6 mb-8">
              {[{num:"01",text:"Simplify your workflow by automating this time-consuming task effortlessly."},{num:"02",text:"View detailed summaries of application attempts for quick review and follow-up."},{num:"03",text:"Answer questions interactively, allowing the chrome extension to fill in job application details seamlessly."}].map((item) => (
                <div key={item.num} className="flex gap-4"><span className="text-[13px] font-bold text-[#c8cdd5] leading-relaxed">{item.num}</span><p className="text-[14px] text-[#555] leading-relaxed">{item.text}</p></div>
              ))}
            </div>
          ...
          <div className="flex-1 max-w-[400px]">
            <div className="bg-white border border-[#e5e7eb] rounded-xl p-6 shadow-sm">
              ...
              <h3 className="text-[16px] font-bold text-[#1a1a1a] mb-3 leading-snug">Discover the power of our LinkedIn extension in optimizing your job application processes.</h3>
              <p className="text-[13px] text-[#666] leading-relaxed">From automated form filling to comprehensive summaries and interactive questionnaires, our chrome extension empowers you to streamline tasks and achieve more with every job application. Revolutionize your workflow and experience efficiency like never before.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="bg-[#1e293b] py-16 text-center px-6">
        ...
        <p className="text-[#b0bec5] text-[14px] max-w-[560px] mx-auto mb-7 leading-relaxed">JobExCV users get in average 50% more interviews and they spend 10 hours less per week. Start automating your job search today.</p>
