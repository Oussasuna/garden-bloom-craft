  ...
  return (
    <div className="bg-[#F4F7F9] min-h-screen">
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="w-full lg:w-1/2">
              ...
              <a href="https://app.firstresume.ai" className="inline-flex items-center bg-black text-white px-6 py-3 rounded-[5px] font-semibold text-[16px] hover:bg-[#1a1a1a] transition-colors">Sign up for free</a>
            </div>
          ...
          <div className="max-w-[1200px] mx-auto px-8">
            <div className={`flex flex-col lg:flex-row items-center gap-10`}>
              <div className={`w-full lg:w-1/2 ${step.reverse ? "lg:pl-16 order-2" : "lg:pr-10 order-2 lg:order-1"}`}>
                ...
                <a href="https://app.firstresume.ai" className="inline-flex items-center bg-black text-white px-6 py-3 rounded-[5px] font-semibold text-[16px] hover:bg-[#1a1a1a] transition-colors">Start today</a>
              </div>
      ...
      <section className="bg-[#e8ebf0] py-[80px] md:py-[100px] text-center px-6 border-t border-[#DFE6ED]">
        ...
        <a href="https://app.firstresume.ai" className="inline-flex items-center bg-black text-white px-6 py-3 rounded-[5px] font-semibold text-[16px] hover:opacity-85 transition-opacity">Get Started Now</a>
      </section>
    </div>
  );
}
